  ...
  return (
    <div style={{ minHeight: "100vh", background: bg, color: textMain, display: "flex", flexDirection: "column", transition: "background 0.3s ease, color 0.3s ease" }}>
      ...
      <style>{`
        ...
        @keyframes glowPulse { 0%,100%{box-shadow:0 0 20px rgba(122,63,209,0.3),0 0 60px rgba(245,166,35,0.1)} 50%{box-shadow:0 0 40px rgba(122,63,209,0.6),0 0 100px rgba(245,166,35,0.25)} }
        @keyframes borderSpin { to { --angle: 360deg; } }
        @keyframes lockBounce { 0%,100%{transform:translateY(0)} 50%{transform:translateY(-4px)} }
        @keyframes unlockGlow { 0%{box-shadow:0 0 0 0 rgba(122,63,209,0.6)} 70%{box-shadow:0 0 0 20px rgba(122,63,209,0)} 100%{box-shadow:0 0 0 0 rgba(122,63,209,0)} }
        ...
        .brochure-input:focus {
          box-shadow: 0 0 0 2px ${inputFocus};
        }
        .brochure-select {
          appearance: none;
        ...
        <div style={{ maxWidth: 860, margin: "0 auto" }}>
          ...
          >
            ...
            <form onSubmit={handleSubmit} noValidate>
                  ...
                  return (
                    <div key={f.key}>
                      ...
                      <input
                        ...
                        disabled={submitted}
                        style={{
                          background: submitted ? (dark ? "rgba(255,255,255,0.03)" : "rgba(122,63,209,0.02)") : inputBg,
                          border: "1px solid " + (errors[f.key] ? "#ff6b6b" : inputBdr),
                          color: textMain,
              ...
              <div style={{ marginBottom: "1rem" }}>
                <label style={{ display: "block", fontFamily: "'Orbitron',sans-serif", fontSize: "0.6rem", fontWeight: 700, letterSpacing: "1px", textTransform: "uppercase", color: textMid, marginBottom: 7 }}>
                  Industry
                </label>
                <select
                  className="brochure-input brochure-select"
                  value={form.industry}
          ...
          <AnimatePresence>
            {submitted && !brochureOpen && (
              ...
              >
                <p style={{ color: textMid, fontSize: "0.82rem", marginBottom: "1.5rem", fontFamily: "'Orbitron',sans-serif", letterSpacing: "0.5px" }}>
              ...
              >
                ...
                >
                  <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                    ...
                    <span style={{ fontFamily: "'Orbitron',sans-serif", fontSize: "0.62rem", fontWeight: 700, letterSpacing: "1.5px", textTransform: "uppercase", color: "#b99eff" }}>
                      TFC 2026 · OFFICIAL SPONSORSHIP BROCHURE
                    </span>
                  </div>
                ...
                <motion.div
                  ...
                  transition={{ delay: 0.25, duration: 0.65, ease: [0.215, 0.61, 0.355, 1] }}
                  style={{ borderRadius: 24, overflow: "hidden", border: "1px solid " + cardBdr, boxShadow: dark ? "0 24px 80px rgba(0,0,0,0.6), 0 0 0 1px rgba(155,135,245,0.10)" : "0 24px 80px rgba(122,63,209,0.12), 0 0 0 1px rgba(122,63,209,0.10)", position: "relative" }}
                >
                  {/* gradient top bar */}
                  ...
                  <div className="pdf-container" style={{ background: dark ? "#0a0518" : "#f5f3ff", overflowY: "auto", maxHeight: "82vh" }}>
                    <iframe
                      ...
                      title="Tech Festival Canada 2026 Brochure"
                ...
                >
                  <div style={{ display: "flex", gap: 6, marginBottom: 4 }}>
                    {[0, 1, 2].map(function (i) {
                      return <motion.div key={i} animate={{ y: [0, -5, 0] }} transition={{ delay: i * 0.15, repeat: Infinity, duration: 1.2 }} style={{ width: 4, height: 4, borderRadius: "50%", background: i === 1 ? "#f5a623" : "#7a3fd1", opacity: 0.8 }} />;
                    })}
                  </div>

                  <motion.a
                    href="/Brochure.pdf"
                    download="TechFestivalCanada_2026_Brochure.pdf"
