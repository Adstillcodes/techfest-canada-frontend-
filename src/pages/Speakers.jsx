...
function SpeakerApplicationModal(props) {
  ...
  var formData = s1[0];
  var setFormData = s1[1];
  var s2 = useState("");
  var error = s2[0];
  var setError = s2[1];
  var s3 = useState(false);
  var submitted = s3[0];
  var setSubmitted = s3[1];
      ...
      >
        <div
          style={{
            ...
            zIndex: 2,
            paddingBottom: 20,
            borderBottom: "1px solid " + inputBdr,
          }}
        >
          <button
            onClick={onClose}
          ...
          <p style={{ fontSize: "0.85rem", color: textMid, lineHeight: 1.6 }}>
            We review every application. Our team will be in touch if there's a
            fit.
          </p>
        </div>
        <div style={{ padding: "24px 32px 32px" }}>
          {submitted ? (
            <div style={{ textAlign: "center", padding: "2rem 0" }}>
              ...
              <p
                style={{ fontSize: "0.9rem", color: textMid, lineHeight: 1.7 }}
              >
                We'll review your submission and reach out if there's a match
                for TTFC 2026.
              </p>
              <button
                onClick={onClose}
            ...
            >
              ...
              <div>
                ...
                >
                  <option value="">Number of conferences</option>
  ...
  return (
    <div
      ...
      onMouseEnter={function (e) {
        ...
        e.currentTarget.style.boxShadow = dark
          ? "0 12px 40px rgba(122,63,209,0.15)"
          : "0 12px 40px rgba(122,63,209,0.10)";
      }}
    ...
    >
        ...
        <div
          style={{
            ...
            background:
              ...
              (dark ? "rgba(6,2,15,0.85)" : "rgba(255,255,255,0.7)") +
              ", transparent)",
            pointerEvents: "none",
          }}
        />
      ...
      >
        ...
        <p
          className="speaker-desc-desktop"
          style={{
            fontSize: "0.76rem",
            color: textMid,
            lineHeight: 1.6,
...
export default function Speakers() {
  ...
  var modalOpen = s2[0];
  var setModalOpen = s2[1];
  var s3 = useState("");
  var search = s3[0];
  var setSearch = s3[1];
  var s4 = useState([]);
  var speakers = s4[0];
  var setSpeakers = s4[1];
        ...
        <main style={{ flex: 1 }}>
          <section className="speakers-hero">
            ...
            <div style={{ position: "relative", zIndex: 2 }}>
              ...
              <p className="spk-sub">
                Hear from the brightest minds in AI, quantum computing,
                cybersecurity, sustainability, and robotics shaping tomorrow's
                world.
              </p>
            ...
            >
              <div
                style={{
                  ...
                  border:
                    "1.5px solid " +
                    (dark ? "rgba(255,255,255,0.10)" : "rgba(122,63,209,0.12)"),
                }}
              >
          ...
          <section
            style={{ padding: "3rem 5%", maxWidth: 1200, margin: "0 auto" }}
          >
            ...
            {loading ? (
              ...
              >
                <div
                  style={{
                    fontSize: "2rem",
                    animation: "spk-spin 1s linear infinite",
                  }}
                >
                  ⟳
                </div>
          ...
          <SponsorMarquee
            dark={dark}
            schemaType="sponsorMarquee"
            title="Where our speakers work at"
          />
          ...
          >
            ...
            >
              ...
              >
                We are assembling a distinguished advisory council of industry
                leaders, policymakers, and technology pioneers. Announcements
          ...
          <div className="spk-cta-band">
            <div>
              <h3>
                Want to <span>Speak</span> at TTFC?
              </h3>
              <p>
                We're looking for visionary leaders, innovators, and experts to
                take the stage. Applications for TTFC 2026 are now open.
              </p>
            </div>
            <button
              onClick={function () {
