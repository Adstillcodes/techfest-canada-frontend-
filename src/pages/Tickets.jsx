...
export default function Tickets() {
  ...
  const passFeatureMap = { connect:[true,true,true,false,true,false,false], influence:[true,true,true,true,true,false,false], power:[true,true,true,true,true,true,true] };
