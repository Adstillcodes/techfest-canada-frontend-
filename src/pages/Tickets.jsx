      ...
      <section className="tickets-section container">
        ...
        <div className="tickets-grid-pricing">
          ...
          <div className="ticket-card disabled">
            <h3>Early Adopter</h3>
            <div className="ticket-price">{early.price?.toLocaleString()}</div>
          ...
          <div className="ticket-card featured">
            ...
            <h3>Festival Pass</h3>
            <div className="ticket-price">{festival.price?.toLocaleString()}</div>
          ...
          <div className="ticket-card">
            ...
            <div className="ticket-price">{vip.price?.toLocaleString()}</div>
